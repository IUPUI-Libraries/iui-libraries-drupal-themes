...
Files copied from core/themes/stable9 to help during development as many of the
files will need copied and overwritten in custom themes. All info and 
configuration files removed to keep Drupal from trying to register as a theme.
